...
const expectRender = `<circle cx="150" cy="150" r="50" fill="${this.color}"/>
...
const textColor = 'white';
const text = 'This is a text';
const expectRender = `<polygon points = "50,50 150,50 100,150" fill="${this.color}" />
<text x="20" y="30" text-anchor="middle" alignment-baseline="middle" font-family="Arial" font-size="30" fill="${this.textColor}">${this.text}</text>`;
...
const textColor = 'white';
const text = 'This is a text';
const expectRender = `<rect x="50" y="50" width="100" height="200" fill="${this.color}" />
<text x="20" y="30" text-anchor="middle" alignment-baseline="middle" font-family="Arial" font-size="30" fill="${this.textColor}">${this.text}</text>`
